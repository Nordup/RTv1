...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/09 17:08:13 by mfalkrea          #+#    #+#             */
/*   Updated: 2020/01/09 17:08:15 by mfalkrea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_mlx(t_rtv1 *rt)
{
	...
	if (!(rt->mlx.mlx_ptr = mlx_init()))
		exit(0);
	if (!(rt->mlx.win_ptr = mlx_new_window(rt->mlx.mlx_ptr, WIN_SIZE,
		WIN_SIZE, "RTv1")))
		exit(0);
...
int		main(int ac, char *av[])
{
	...
	mlx_put_image_to_window(rt->mlx.mlx_ptr, rt->mlx.win_ptr,
		rt->mlx.img_ptr, 0, 0);
	mlx_hook(rt->mlx.win_ptr, 2, 0, ft_key_macos, rt);
